...
export const luggages: ILuggage[] = [
  ...
  {
    createdAt: new Date(
      new Date('11/08/2022').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
    ...
    name: 'Håkan',
    arrivalTime: new Date(
      new Date('11/09/2022').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
    bags: '9+4',
    comments: null,
    tagNr: '5038',
  ...
  {
    createdAt: new Date(
      new Date('11/07/2022').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
  ...
  {
    createdAt: new Date(
      new Date('11/04/2022').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
    ...
    name: 'Lucrèce',
    arrivalTime: new Date(
      new Date('11/05/2022').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
    bags: '2+5',
    comments: 'Fusce lacus purus, aliquet at, feugiat non, pretium quis, lectus.',
    tagNr: '0797',
  ...
  {
    createdAt: new Date(
      new Date('11/03/2022').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
  ...
  {
    createdAt: new Date(
      new Date('11/06/2022').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
  ...
  {
    createdAt: new Date(
      new Date('11/01/2022').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
    ...
    name: 'Angélique',
    arrivalTime: new Date(
      new Date('11/02/2022').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
    bags: '7+1',
    comments: null,
    tagNr: '1883',
