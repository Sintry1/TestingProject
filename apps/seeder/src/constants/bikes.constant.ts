...
export const bikes: IBike[] = [
  ...
  {
    createdAt: new Date(
      new Date('2/24/2023').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
    bikeId: '0fe76378-7b1f-4cd8-acfb-40b0662456f4',
    nrOfBikes: '1',
    pickUpTime: new Date(
      new Date('3/14/2023').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
    name: 'Naéva',
    room: '742',
    reservedBy: 'bm',
    ...
    completedAt: new Date(
      new Date('3/3/2023').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
  },
  {
    createdAt: new Date(
      new Date('2/15/2023').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
    bikeId: '5b0c5562-71ba-4570-9de1-a0cf417a7751',
    nrOfBikes: '5',
    pickUpTime: new Date(
      new Date('3/5/2023').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
    name: 'Mélanie',
    room: '116',
    reservedBy: 'uy',
  ...
  {
    createdAt: new Date(
      new Date('2/19/2023').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
    bikeId: '95d18649-ec0d-43a0-b793-1880cefc9ecf',
    nrOfBikes: '8',
    pickUpTime: new Date(
      new Date('3/9/2023').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
    name: 'Gérald',
    room: '826',
    reservedBy: 'qp',
    ...
    comments: null,
    completedAt: new Date(
      new Date('2/26/2023').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
  },
  {
    createdAt: new Date(
    ...
    nrOfBikes: '4',
    pickUpTime: new Date(
      new Date('2/22/2023').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
    name: 'Clélia',
    room: '780',
    reservedBy: 'dm',
    ...
    completedAt: new Date(
      new Date('2/11/2023').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
  },
  {
    createdAt: new Date(
  ...
  },
  {
    ...
    comments: null,
    completedAt: new Date(
      new Date('2/8/2023').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
  },
  {
    createdAt: new Date(
    ...
    nrOfBikes: '9',
    pickUpTime: new Date(
      new Date('3/16/2023').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
    name: 'Léonie',
    room: '395',
    reservedBy: 'tf',
  ...
  },
  {
    ...
    nrOfBikes: '0',
    pickUpTime: new Date(
      new Date('2/21/2023').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
    name: 'Daphnée',
    room: '024',
    reservedBy: 'js',
    ...
    completedAt: new Date(
      new Date('2/10/2023').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
  },
  {
    createdAt: new Date(
  ...
  {
    createdAt: new Date(
      new Date('2/23/2023').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
    bikeId: 'f573629a-c343-4e45-b03d-7ebd25b063f7',
    nrOfBikes: '3',
    pickUpTime: new Date(
      new Date('3/13/2023').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
    name: 'Loïca',
    room: '747',
    reservedBy: 'az',
    ...
    completedAt: new Date(
      new Date('3/2/2023').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
  },
  {
    createdAt: new Date(
  ...
  },
  {
    ...
    nrOfBikes: '2',
    pickUpTime: new Date(
      new Date('2/14/2023').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
    name: 'Aí',
    room: '484',
    reservedBy: 'vz',
  ...
  },
  {
    ...
    comments: null,
    completedAt: new Date(
      new Date('2/17/2023').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
  },
  {
    createdAt: new Date(
  ...
  {
    createdAt: new Date(
      new Date('2/13/2023').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
    ...
    completedAt: new Date(
      new Date('2/20/2023').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
  },
  {
    createdAt: new Date(
  ...
  },
  {
    ...
    nrOfBikes: '8',
    pickUpTime: new Date(
      new Date('2/28/2023').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
    name: 'Marylène',
    room: '508',
    reservedBy: 'tb',
  ...
  {
    createdAt: new Date(
      new Date('2/25/2023').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
    bikeId: '570f9c17-92c9-4e15-87ff-56771ca1b8d5',
    nrOfBikes: '6',
    pickUpTime: new Date(
      new Date('3/15/2023').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
    name: 'Mårten',
    room: '356',
    reservedBy: 'in',
    ...
    comments: null,
    completedAt: new Date(
      new Date('3/4/2023').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
  },
  {
    createdAt: new Date(
      new Date('2/9/2023').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
    bikeId: '4a85dc1b-83c8-4704-9a0b-0867e38cde18',
    nrOfBikes: '1',
    pickUpTime: new Date(
      new Date('2/27/2023').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
    name: 'Naëlle',
    room: '892',
    reservedBy: 'ug',
    ...
    comments: null,
    completedAt: new Date(
      new Date('2/16/2023').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
  },
  {
    createdAt: new Date(
    ...
    nrOfBikes: '7',
    pickUpTime: new Date(
      new Date('3/7/2023').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
    name: 'Naéva',
    room: '200',
    reservedBy: 'iz',
  ...
  },
  {
    ...
    nrOfBikes: '3',
    pickUpTime: new Date(
      new Date('3/11/2023').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
    name: 'Aí',
    room: '878',
    reservedBy: 'pu',
  ...
  },
  {
    ...
    nrOfBikes: '6',
    pickUpTime: new Date(
      new Date('2/18/2023').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
    name: 'Aimée',
    room: '170',
    reservedBy: 'kt',
  ...
  },
  {
    ...
    nrOfBikes: '9',
    pickUpTime: new Date(
      new Date('3/8/2023').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
    name: 'Marie-thérèse',
    room: '309',
    reservedBy: 'oy',
  ...
  },
  {
    ...
    comments: null,
    completedAt: new Date(
      new Date('3/1/2023').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
  },
  {
    createdAt: new Date(
  ...
  },
  {
    ...
    nrOfBikes: '5',
    pickUpTime: new Date(
      new Date('3/6/2023').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
    name: 'Fèi',
    room: '871',
    reservedBy: 'nl',
  ...
  },
  {
    ...
    comments: null,
    completedAt: new Date(
      new Date('2/12/2023').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
  },
  {
    createdAt: new Date(
  ...
  },
  {
    ...
    nrOfBikes: '9',
    pickUpTime: new Date(
      new Date('3/12/2023').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
    name: 'Bérangère',
    room: '621',
    reservedBy: 'uh',
  ...
  },
  {
    ...
    nrOfBikes: '1',
    pickUpTime: new Date(
      new Date('3/10/2023').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
    name: 'Lyséa',
    room: '585',
    reservedBy: 'dx',
  ...
  },
  {
    ...
    nrOfBikes: '2',
    pickUpTime: new Date(
      new Date('3/17/2023').setHours(Math.random() * (23 - 2) + 2, Math.random() * (59 - 1) + 1)
    ),
    name: 'Aí',
    room: '364',
    reservedBy: 'dn',
